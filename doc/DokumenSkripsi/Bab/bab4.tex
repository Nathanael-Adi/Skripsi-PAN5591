...
\begin{figure} [H]
    \centering
    \includegraphics[scale=0.75]{Gambar/Rugby Indonesia UML Class Diagram Rev V1.png}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[scale=0.225]{Gambar/Teammate_Photos UI Dev.png}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[scale=0.225]{Gambar/Select_Frame UI Dev.png}
